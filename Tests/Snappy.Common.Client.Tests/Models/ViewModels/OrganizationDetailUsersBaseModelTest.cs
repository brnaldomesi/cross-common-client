...
{
    [TestFixture]
    public class OrganizationDetailUsersBaseModelTest : BaseViewModelTest<OrganizationDetailUsersBaseModel>
    {
        public OrganizationDetailUsersBaseModel SystemUnderTest { get; set; }
        ...
        {
            Assert.AreEqual(SystemUnderTest.Title, "organization_users_title");
        }
    }
}