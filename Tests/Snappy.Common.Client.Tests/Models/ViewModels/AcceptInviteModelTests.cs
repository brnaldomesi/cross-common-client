...
{
    [TestFixture]
    public class AcceptInviteModelTests
    {
        [Test]
        public void AcceptInviteModel_has_title()
        {
            var model = GetModel();
        ...
        public void AcceptInviteModel_Validates_AddsErrorMessages(string firstName, string lastName, string newPassword, string reEnterNewPassword,string errorMessage)
        {
            var model = GetModel();
        ...
        [Test]
        public void AcceptInviteModel_has_FirstNameInputModel()
        {
            var model = GetModel();
        ...
        [Test]
        public void AcceptInviteModel_has_LastNameInputModel()
        {
            var model = GetModel();
        ...
        [Test]
        public void AcceptInviteModel_has_NewPasswordInputModel()
        {
            var model = GetModel();
        ...
        [Test]
        public void AcceptInviteModel_has_ReEnterNewPasswordInputModel()
        {
            var model = GetModel();
        ...
        private static AcceptInviteModel GetModel()
        {
